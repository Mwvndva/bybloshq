...
function auditCreatorExperience() {
  ...
  check('Creator experience', 'Creator dashboard has requests, linked shops, leaderboard, clicks, withdrawals, and period analysis', hasAll('src/pages/creator/CreatorDashboard.tsx', [/Shop requests/, /Linked shops/, /Top creators/, /Link clicks/, /Withdraw to M-Pesa/, /daily/, /weekly/, /monthly/, /Sales value/]), 'Creator dashboard analytics coverage is incomplete.');
...
function auditAdminAndOperations() {
  ...
  check('Admin and operations', 'Admin can inspect payouts, balances, sellers, buyers, clients, and logistics', hasAll('server/src/controllers/admin.controller.js', [/getAllWithdrawalRequests/, /getPaymentProviderBalances/, /getAllSellers/, /getAllBuyers/, /getAllClients/, /getAdminLogisticsRequests/]), 'Admin controller is missing an operational surface.');
