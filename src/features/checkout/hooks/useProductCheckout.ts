...
import { calculateBuyerPayableTotal, calculateProductServiceCharge, createCheckoutAttemptToken, getProductCardThemeVars, getProductFlags, getThemeClasses, normalizePhone, normalizeProductImages, type Theme } from '@/features/shop/utils/productCardUtils';
...
export function useProductCheckout(product: Product, seller: Seller | undefined, theme: Theme | undefined) {
