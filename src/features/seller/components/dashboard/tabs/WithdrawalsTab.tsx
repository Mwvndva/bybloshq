  ...
  return (
    <div className="space-y-4 sm:space-y-6 lg:space-y-8">
      <div className="text-center px-2 sm:px-0">
        <h2 className="text-lg sm:text-xl lg:text-2xl font-black text-slate-900 dark:text-white mb-1.5">Withdrawal Management</h2>
      ...
      <div className="rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 border border-slate-200 bg-white dark:border-white/10 dark:bg-[#0a0a0a] shadow-[0_12px_35px_rgba(0,0,0,0.45)]">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-2xl sm:text-3xl md:text-4xl font-black text-emerald-500 dark:text-emerald-400 tracking-tight tabular-nums">
              {formatKes(balance)}
            </p>
      ...
      <div className="grid grid-cols-3 gap-2 sm:gap-3 md:gap-4">
        ...
        <div className="rounded-xl sm:rounded-2xl p-2.5 sm:p-4 border border-slate-200 bg-white dark:border-white/10 dark:bg-[#0a0a0a] shadow-sm flex flex-col justify-between min-w-0">
          <div>
            ...
            <p className="mt-0.5 sm:mt-1 text-xs sm:text-base md:text-xl font-black text-slate-900 dark:text-white truncate tabular-nums">
      ...
      <div className="rounded-xl border border-yellow-400/25 bg-yellow-400/10 p-2.5 sm:p-3 flex items-start gap-2 sm:gap-3">
        ...
        <div className="flex-1 min-w-0">
          <h4 className="font-black text-slate-900 dark:text-white text-[10px] sm:text-xs">Minimum: KSh {MIN_WITHDRAWAL_AMOUNT}</h4>
          ...
          <div className="mt-2 grid gap-1 text-[9px] sm:text-[10px] font-black text-slate-900 dark:text-white sm:grid-cols-3">
      ...
      <div className="rounded-2xl sm:rounded-3xl p-3 sm:p-6 md:p-8 border border-slate-200 bg-white dark:border-white/10 dark:bg-[#0a0a0a] shadow-[0_12px_35px_rgba(0,0,0,0.45)]">
        <div className="flex flex-col gap-3 sm:flex-row sm:justify-between sm:items-center mb-4 sm:mb-6">
          <div>
            <h3 className="text-lg sm:text-xl md:text-2xl font-black text-slate-900 dark:text-white">Withdrawal Requests</h3>
        ...
        {filteredWithdrawals.length > 0 ? (
          ...
          <div className="text-center py-20">
            ...
            <h3 className="text-xl font-black text-slate-900 dark:text-white mb-3">No withdrawal requests</h3>
