        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-2xl bg-black/95 backdrop-blur-sm shadow-2xl rounded-3xl border border-white/10">
                <DialogHeader>
                    ...
                    <p className="text-center text-gray-300 font-medium">{eventName}</p>
                </DialogHeader>
                ...
                <div className="mt-6">
                    {isLoading ? (
                        ...
                        <div className="text-center py-12 bg-white/5 rounded-2xl border border-dashed border-white/10">
                            <p className="text-gray-300">No withdrawal history found for this event.</p>
                        </div>
                    ) : (
                                ...
                                >
                                    ...
                                    <div className="bg-white/5 rounded-xl p-3 text-sm space-y-2 border border-white/5">
                                        ...
                                        {withdrawal.provider_reference && (
                                            <div className="flex justify-between">
                                                <span className="text-gray-300">Ref ID</span>
