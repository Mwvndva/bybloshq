...
export const UnifiedAnalyticsHub: React.FC<UnifiedAnalyticsHubProps> = ({
    ...
    return (
        <motion.div
            ...
            className="relative w-full overflow-hidden rounded-[var(--radius-xl)] border border-white/10 bg-[rgba(17,17,17,0.8)] backdrop-blur-[16px] shadow-2xl"
        >
            ...
            {/* Grid Layout: Enforced 2 columns on mobile */}
            <div className="grid grid-cols-2 lg:grid-cols-4 relative z-10">

                {/* Metric 1: Sales */}
                <div className="group relative p-[var(--space-3)] sm:p-[var(--space-5)] flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-white/5 transition-all duration-300 hover:bg-white/5">
                    ...
                    <div className="space-y-0.5 sm:space-y-1">
                        <h3 className="text-gray-400 text-[var(--text-xs)] font-medium uppercase tracking-wider truncate">Sales</h3>
                        <p className="text-[clamp(1.25rem,3vw,2.25rem)] font-black text-white tracking-tight truncate">
                ...
                <div className="group relative p-[var(--space-3)] sm:p-[var(--space-5)] flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-white/5 transition-all duration-300 hover:bg-white/5">
                    <div className="space-y-0.5 sm:space-y-1">
                        <h3 className="text-gray-400 text-[var(--text-xs)] font-medium uppercase tracking-wider truncate">Revenue</h3>
                        <p className="text-[clamp(1.25rem,3vw,2.25rem)] font-black text-white/90 tracking-tight truncate">
                ...
                <div className="group relative p-[var(--space-3)] sm:p-[var(--space-5)] flex flex-col justify-between border-r lg:border-b-0 lg:border-r border-white/5 transition-all duration-300 hover:bg-white/5 bg-gradient-to-b from-transparent to-emerald-500/5 hover:to-emerald-500/10">
                    ...
                    <div className="space-y-0.5 sm:space-y-1 relative z-10">
                        <div className="flex items-center justify-between">
                            <h3 className="text-emerald-400/80 text-[var(--text-xs)] font-bold uppercase tracking-wider truncate">Balance</h3>
                ...
                <div className="group relative p-[var(--space-3)] sm:p-[var(--space-5)] flex flex-col justify-between transition-all duration-300 hover:bg-white/5">
                    <div className="absolute top-0 right-0 p-2 sm:p-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <CreditCard className="h-8 w-8 sm:h-12 sm:w-12 text-purple-500/10" />
                    </div>

                    <div className="space-y-0.5 sm:space-y-1">
                        <h3 className="text-gray-400 text-[var(--text-xs)] font-medium uppercase tracking-wider truncate">Pending</h3>
