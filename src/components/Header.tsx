        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="flex items-center gap-3 md:gap-6">
            ...
            <Link to={isSellerAuthenticated ? "/seller/dashboard" : "/seller/register"}>
              <Button
                className="bg-yellow/300 hover:bg-white/20 text-black rounded-full px-6 transition-all duration-300 border border-white/10 hover:border-white/20 shadow-lg backdrop-blur-md"
