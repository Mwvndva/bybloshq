...
const fieldClassName = 'h-10 border border-white/10 bg-[#141414] text-white placeholder:text-white/40 focus-visible:ring-[#F5C518]';
        ...
        <div className="flex-1 overflow-y-auto px-4 py-5 sm:px-5">
          <section className="space-y-3 rounded-2xl border border-white/10 bg-[#0a0a0a] p-4 shadow-sm">
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-xs text-white/50">Your saved buyer information.</p>
              </div>
              <Button
                type="button"
          ...
          {isEditingProfile && (
            <section className="mt-4 space-y-3 rounded-2xl border border-white/10 bg-[#0a0a0a] p-4 shadow-sm">
              ...
              <Button onClick={onSaveProfile} disabled={isSavingProfile} className="w-full bg-[#F5C518] text-black h-10 font-bold hover:bg-yellow-300">
