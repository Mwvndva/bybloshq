...
const NativeAppHome = () => (
  <div className="flex min-h-[100svh] items-center justify-center bg-white px-6 py-10 text-stone-950 selection:bg-yellow-300 selection:text-black">
    <main className="flex w-full max-w-sm flex-col items-center gap-8 text-center">
      ...
      <div className="flex w-full flex-col gap-3">
        <Link to="/creator/login" className="w-full">
