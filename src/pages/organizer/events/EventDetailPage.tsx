      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center space-x-4 mb-4">
            <h1 className="text-4xl font-black text-black">{safeEvent.title}</h1>
              <Button 
                variant="ghost" 
                size="icon" 
        ...
        <div className="flex flex-wrap justify-center gap-2 mb-8 sm:mb-12 bg-white/60 backdrop-blur-sm p-2 rounded-2xl shadow-lg border border-gray-200/50 w-full sm:w-fit mx-auto">
          ...
          >
            <Tag className="h-4 w-4 sm:h-5 sm:w-5 mr-1 sm:mr-2 flex-shrink-0" />
        ...
        {activeTab === 'overview' && (
          <div className="space-y-12">
            <div className="text-center">
              <h2 className="text-4xl font-black text-black mb-4">Event Overview</h2>
        ...
        {activeTab === 'analytics' && (
          <div className="space-y-12">
            <div className="text-center">
              <h2 className="text-4xl font-black text-black mb-4">Event Analytics</h2>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-3xl font-black text-black mb-2">{analytics.totalTicketsSold.toLocaleString()}</p>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-3xl font-black text-black mb-2">{analytics.totalScannedTickets.toLocaleString()}</p>
        ...
        {activeTab === 'promo-codes' && (
          <div className="space-y-12">
            <div className="text-center">
              <h2 className="text-4xl font-black text-black mb-4">Promo Codes</h2>
              <p className="text-gray-600 text-lg font-medium">Create and manage discount codes for your event</p>
            </div>
            <PromoCodeManager eventId={parseInt(safeEvent.id)} />
          </div>
        )}
        ...
        {activeTab === 'settings' && (
          <div className="space-y-12">
            <div className="text-center">
              <h2 className="text-4xl font-black text-black mb-4">Event Settings</h2>
