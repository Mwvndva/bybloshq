...
function auditAdminAndOperations() {
  ...
  check('Admin and operations', 'Admin can inspect payouts, balances, sellers, creators, buyers, clients, and logistics', hasAll('server/src/controllers/admin.controller.js', [/getAllWithdrawalRequests/, /getPaymentProviderBalances/, /getAllSellers/, /getAllCreators/, /deleteCreator/, /getAllBuyers/, /getAllClients/, /getAdminLogisticsRequests/]) && hasAll('server/src/routes/admin.routes.js', [/delete\('\/creators\/:id'/]) && hasAll('server/src/services/admin.service.js', [/mpesa_number = CONCAT\('deleted-'/]) && hasAll('src/pages/admin/components/AdminDashboardTabs.tsx', [/Creators/]) && hasAll('src/pages/admin/NewDashboardPage.tsx', [/Creator Network/, /linkedShops/, /totalCreatorEarnings/, /handleDeleteCreator/, /Trash2/]), 'Admin controller is missing an operational surface.');
