...
if(Test-Path "$Root\server\src"){
    $SourceRoots += "$Root\server\src"
}

if(Test-Path "$Root\server\migrations"){
    $SourceRoots += "$Root\server\migrations"
}

if(Test-Path "$Root\server\scripts"){
    $SourceRoots += "$Root\server\scripts"
}
