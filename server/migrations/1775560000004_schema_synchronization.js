export const up = async (pgm) => {
    ...
    // 7. Create user_digital_access table
...
export const down = async (pgm) => {
    // Note: We don't usually delete enums or columns in a repair down to avoid data loss
    // unless explicitly requested by the flow.
    pgm.dropTable('user_digital_access', { ifExists: true });
    pgm.dropTable('service_slots', { ifExists: true });
};
