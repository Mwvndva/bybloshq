...
const MARKETING_PASSWORD = process.env.MARKETING_ADMIN_PASSWORD || 'byblosmarketing'
...
async function seedMarketingAdmin() {
    ...
    try {
       ...
       RETURNING id, email, role`,
        ...
        console.log('')
        console.log('🎉 Done. Login at /marketing/login with:')
        console.log(`   Email:    ${MARKETING_EMAIL}`)
        console.log(`   Password: ${MARKETING_PASSWORD}`)
    } catch (err) {
