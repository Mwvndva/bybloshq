...
export const registerDevice = z.object({ token: s, deviceType: s }).passthrough();
export const unregisterDevice = z.object({ token: s }).passthrough();
export const unregisterDeviceByToken = z.object({ token: id }).passthrough();
export const markRead = z.object({ notificationId: id }).passthrough();
