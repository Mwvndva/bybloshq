...
import paymentSSERoutes from './routes/payment-sse.routes.js';
...
app.use('/api/payments', paymentSSERoutes); // SSE routes for real-time updates
...
protectedEventRouter.patch('/:id', eventController.updateEvent);
