...
export class PaymentLifecycleService {
    ...
    async initiatePayment(paymentData) {
        ...
        return this.providerClient.initiateCharge(paymentData);
    }
    ...
    async checkTransactionStatus(transactionId) {
        return this.providerClient.verifyTransaction(transactionId);
    }
    ...
    async initiateProductPaymentLegacy(normalizedOrder) {
...
export default new PaymentLifecycleService();
